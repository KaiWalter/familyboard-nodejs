...
## 1. Overview
A single-page kiosk-style information display application that combines a forward-looking multi-week schedule view with a rotating media panel. Designed for unattended operation, resilient data refresh, clear configurability, and deterministic UI layout.
